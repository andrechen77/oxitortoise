...
use crate::sim::{agent::AgentIndexIntoWorld, value::agentset::{AllPatches, AllTurtles, IterateAgentset}};

use super::{CanonClosure, CanonExecutionContext};

#[no_mangle]
#[inline(never)]
pub extern "C" fn ask_all_turtles(
...
#[no_mangle]
#[inline(never)]
pub extern "C" fn ask_all_patches(
    context: &mut CanonExecutionContext,
    operation: CanonClosure,
) {
